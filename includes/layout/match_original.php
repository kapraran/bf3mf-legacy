        ...
        <div class="match-clan">
            ...
            <div class="match-clan-card">
                ...
                <div class="match-clan-info">
                    ...
                    <div class="b-i"><span class="tag">[<?php echo $clan_info['tag'] ?>]</span> <span class="country"> <img src="img/flags/<?php echo $clan_info['country'] ?>.png" alt="<?php echo $COUNTRIES[$clan_info['country']] ?>"> <?php echo $COUNTRIES[$clan_info['country']] ?></span></div>
            ...
            <table id="clan-table">
                <tbody>
                    ...
                    <tr>
                        <td class="label"><?php echo ($LOGGED) ? 'Match tools' : ''; ?></td>
                    </tr>
                    <tr>
                        <td class="value">
                            ...
                            <?php elseif ($LOGGED): ?>
                                ...
                                <?php if ($MATCH->already_challenged($MODE_PARS['id'])): ?>
