    ...
    <div class="match-info">
      ...
      <div class="match-info-block">
        ...
        <table class="match-table">
          <tbody>
            <tr class="label">
              <td colspan="2">Team is available between <a href="res/tooltip/time_date.htm?width=280" class="jTip"
                  id="one" name="Date/Time info:">?</a></td>
            </tr>
            <tr class="values">
      ...
      <div class="match-clan-card">
        ...
        <div class="match-clan-info">
          ...
          <div class="b-i">
            ...
            <span class="country"> <img src="img/flags/<?php echo $clan_info['country']; ?>.png"
                alt="<?php echo $COUNTRIES[$clan_info['country']]; ?>">
              <?php echo $COUNTRIES[$clan_info['country']]; ?></span>
            ...
            <span><?php
                                    generate_info_btn($clan_info['id']);
                                    generate_send_msg_btn($clan_info['id']);
                                    ?></span>
            <?php endif; ?>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="clan">
                        ...
                        <div class="info"><img src="img/flags/<?php echo $chall_info['country']; ?>.png" title="">
                          [<?php echo $chall_info['tag']; ?>]</div>
                      </td>
                      <td class="accept">
                        <form method="post"
