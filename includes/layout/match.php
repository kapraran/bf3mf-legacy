...
$V_maps_list = $MATCH->prep_match_list($match_info['map1'], $match_info['map2'], $match_info['map3']);
...
<div id="main">
    ...
    <div id="notification" class="success" >
        ...
        <?php display_msg('match', (get_parameter('errorcode') === '') ? 0 : get_parameter('errorcode'));?>
                        ...
                        <tr class="values">
                            <td colspan="2">
                                <div class="match-notes">
                                    <?php
echo (strlen($match_info['notes']) > 0) ? $match_info['notes'] : 'There are no extra notes';
?>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr class="values">
                            <td colspan="2">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="rec-map">
                                        <div class="map-bg" style="background:url( <?php echo $array['image']; ?> )"></div>
                                        <div class="map-name"><span><?php echo $array['name']; ?></span></div>
                                    </div>
                                    <?php endforeach;?>
        ...
        <div class="match-clan">
            ...
            <div class="match-clan-card">
                ...
                <div class="avatar">
                    ...
                    <img src="<?php echo $clan_info['avatar']; ?>" alt="no logo" />
                ...
                <div class="match-clan-info">
                    ...
                    <div class="b-i">
                        <span class="tag">[<?php echo $clan_info['tag'] ?>]</span>
                        <span class="country"> <img src="img/flags/<?php echo $clan_info['country'] ?>.png" alt="<?php echo $COUNTRIES[$clan_info['country']] ?>"> <?php echo $COUNTRIES[$clan_info['country']] ?></span>

                        <?php if ($LOGGED && $_SESSION['id'] != $clan_info['id']): ?>
                            <span><?php generate_info_btn($clan_info['id']);
generate_send_msg_btn($clan_info['id']);?></span>
                        <?php endif;?>
            ...
            <table id="clan-table">
                <tbody>
                    ...
                    <tr>
                        <td class="value">
                            <?php //echo htmlspecialchars($clan_info['coninfo']); ?>
                    ...
                    <tr>
                        <td class="value">
                            <input type="text" readonly="readonly" value="<?php echo $clan_info['battlelog']; ?>"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <?php if ($LOGGED): /* USER LOGGED IN */?>
                            ...
                            <?php if ($_SESSION['id'] == $clan_info['id']): /* CREATOR OF THE MATCH */?>
                                    ...
                                    <tr>
                                        <td class="value">
                                            <form action='./deletematch/<?php echo $MODE_PARS['id'] ?>' method="post" onsubmit="return conf()">
        ...
        $challenge_list = $MATCH->get_challenges($MODE_PARS['id']);
        if (!is_array($challenge_list) && $challenge_list === true) {
    ...
    ?>
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <?php foreach ($challenge_list as $key => $chall_info): ?>
                                                    ...
                                                    <tr>
                                                        <td class="clan">
                                                            <div class="name"><?php echo $chall_info['name']; ?></div>
                                                            <div class="info"><img src="img/flags/<?php echo $chall_info['country']; ?>.png" title=""> [<?php echo $chall_info['tag']; ?>]</div>
                                                        </td>
                                                        <td class="accept">
                                                            <form method="post" action="./acceptchallenge/<?php echo $MODE_PARS['id']; ?>/<?php echo $chall_info['challenge']; ?>" onsubmit="return conf()">
                                                                <input type="hidden" name="secid" value="<?php echo $_SESSION['secid']; ?>" />
                                                                <button class="y-btn">Accept</button>
                                                            </form>
                                                        </td>
                                                        <td class="decline">
                                                            <form method="post" action="./declinechallenge/<?php echo $MODE_PARS['id']; ?>/<?php echo $chall_info['challenge']; ?>" onsubmit="return conf()">
                                                                <input type="hidden" name="secid" value="<?php echo $_SESSION['secid']; ?>" />
                        ...
                        <?php else: /* VISITOR OF THE MATCH */?>

                                <?php if ($MATCH->already_challenged($MODE_PARS['id'])): /* MATCH OPPONENT NOT DECIDED YET AND CURRENT USER HAS SENT A CHALLENGE */?>
                                        ...
                                        <tr>
                                            <td class="value">
                                                ...
                                                <div class="td-row">
                                                    <span class="text">Acceptance status: </span> <?php $MATCH->challenge_status($MODE_PARS['id'], true);?>
                                                </div>
                                            </td>
                                        </tr>

                                    <?php elseif (!$MATCH->check_if_accepted($MODE_PARS['id']) && !$MATCH->already_challenged($MODE_PARS['id'])): ?>
